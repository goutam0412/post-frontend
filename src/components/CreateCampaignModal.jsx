    ...
    <div className='space-y-6'>
      ...
      <div>
        ...
        <div className='relative date-picker-wrapper'>
          ...
          {showDatePicker && (
            <div
              className='absolute z-[100] bottom-full mb-2 left-0 shadow-2xl border border-gray-200 rounded-lg overflow-hidden bg-white'
              ...
              <DateRange
                ...
                onChange={(item) => {
                  ...
                  if (startDate && endDate) {
                    setFormData({
                      ...formData,
                      schedule: `${format(startDate, 'yyyy-MM-dd')} to ${format(
                        endDate,
                        'yyyy-MM-dd'
                      )}`,
                    })
